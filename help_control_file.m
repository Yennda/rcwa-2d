...
switch measurement
    ...
    case 6
        ...
        plot(a(:,1),a(:,3));
    case 7
        for cycle_w=minimum_wavelength:step_w:maximum_wavelength        
            clear loop_index2
            record_0=[];        
            record_90=[];        
            record_psi=[];        
            fid = fopen('data4.txt', 'wt');
            save_m_as_backup=save_m_as;
            save_m_as=[save_m_as_backup,'_',num2str(cycle_w),];
            for cycle_t=minimum_angle_theta:step_t:maximum_angle_theta                        
            ...
            if save_m==1
                copyfile('data4.txt',[save_m_as,'.txt'])
            end
            save_m_as=save_m_as_backup;
        end
