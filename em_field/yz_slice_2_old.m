...
yz_slice_coordinate_x=0.5;
resolution_y=200;
resolution_z=200;

%if yz_slice_coordinate_z<0 || yz_slice_coordinate_z>sum(thickness(2:end-1))
...
z_points=0:sum(thickness)/resolution_z:(sum(thickness)-1/resolution_z);
