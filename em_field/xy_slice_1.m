...
if plot_field_component==1 % E_1
    ...
    E_1_harmonics3=reshape(E_1_harmonics3_v',n_y,n_x)';
...
elseif plot_field_component==2 % E_2
    ...
    E_2_harmonics3=reshape(E_2_harmonics3_v',n_y,n_x)';
...
elseif plot_field_component==3 % E_3
    ...
    E_3_harmonics3=reshape(E_3_harmonics3_v',n_y,n_x)';
...
elseif plot_field_component==4 % H_1
    ...
    H_1_harmonics3=reshape(H_1_harmonics3_v',n_y,n_x)';
...
elseif plot_field_component==5 % H_2
    ...
    H_2_harmonics3=reshape(H_2_harmonics3_v',n_y,n_x)';
...
elseif plot_field_component==6 % H_3
    ...
    H_3_harmonics3=reshape(H_3_harmonics3_v',n_y,n_x)';
