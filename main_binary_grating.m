...
lambda=1; % [um]
theta0=10; % incident angle [degree], if theta=0 -> theta0+1E-10
...
switch grating
    case 0
        setup_dispersion;
        open_grating_file='peng_simple_dielectric_grating.m';
