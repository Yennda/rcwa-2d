...
%---------------------------------------------------
N_X=5; % N_X=20 takes approx. 8 GB of memory
N_Y=N_X;
use_fftw=2;
%---------------------------------------------------
Lambda_x=1; %  [um] only grating 1 and 2
Lambda_y=1; %  [um] only for grating 1 and 2
n_1=1.0; % superstrate
n_3=1.5; % substrate
mu=1;
%---------------------------------------------------
...
switch grating
    case 0
        setup_dispersion;
        open_grating_file='test_antos_grating.m';
