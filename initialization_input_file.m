...
if factorization_method~=0
    if measurement>=2 && measurement<=7
        ...
        if use_fftw==2
            if factorization_method==1 || factorization_method==2
                ...
                NN_x=asr_fourier_2D(p_x,p_y,p_x,p_y,sqrt(N_x_input.*N_x_input),N_X,N_Y,1,mex_speedup,use_grid_asr_speed_up);            
                NN_y=asr_fourier_2D(p_x,p_y,p_x,p_y,sqrt(N_y_input.*N_y_input),N_X,N_Y,1,mex_speedup,use_grid_asr_speed_up);  
