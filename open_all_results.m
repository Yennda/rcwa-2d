...
position_diff_efficiency_R=1+1+(diffraction_efficiency_order(2)+N_Y)+(2*N_Y+1)*(diffraction_efficiency_order(1)+N_X); % 1+    
position_diff_efficiency_T=n_sq+1+1+(diffraction_efficiency_order(2)+N_Y)+(2*N_Y+1)*(diffraction_efficiency_order(1)+N_X); % n_sq+1
