...
% 2D Fourier Coefficients of (epsilon)
E=PFC2DGraphene(a_ellipse,Lambda_x,Lambda_y,n_cylinder^2,n_layer^2,N_X,N_Y,zeta);
A=PFC2DGraphene(a_ellipse,Lambda_x,Lambda_y,1/n_cylinder^2,1/n_layer^2,N_X,N_Y,zeta);
[bt_E tb_E]=PLI2DGraphene(a_ellipse,Lambda_x,Lambda_y,n_cylinder^2,n_layer^2,N_X,N_Y,zeta);
